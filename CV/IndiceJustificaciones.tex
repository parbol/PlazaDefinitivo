...
\subsection{Capacitación linguística}
\includepdf[pages=-]{FormacionAcademica/CapacitacionLinguistica.pdf}
...
\includepdf[pages=-]{ExperienciaCientificaYTecnologica/ProyectosInvestigacionConcurrenciaCompetitiva/Investigacion_Proyectos_Simulacion_UltraRapida.pdf}
...
\includepdf[pages=-]{ExperienciaCientificaYTecnologica/ProyectosInvestigacionConcurrenciaCompetitiva/Investigacion_Proyectos_TomografoMuones_RD_PDC2021_redux.pdf}

\subsection{Actividades del IFCA para los "upgrades" de alta luminosidad del LHC: Inner Tracker y Endcap Timing Layer}
\includepdf[pages=-]{ExperienciaCientificaYTecnologica/ProyectosInvestigacionConcurrenciaCompetitiva/Investigacion_Proyectos_Actividades_del_IFCA.pdf}
...
\subsection{Acreditación Profesor Titular}
\includepdf[pages=-]{ExperienciaCientificaYTecnologica/Acreditaciones/ProfesorTitular.pdf}

\subsection{Acreditación I3}
\includepdf[pages=-]{ExperienciaCientificaYTecnologica/Acreditaciones/CertificacionI3.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/Libros/Investigacion_Libros_LibroBlanco_Redux.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/Muography2021_CertificateAttendance_Pablo.pdf}

\subsection{Tomografía muónica y TPA-TCT, Workshop on LHC technologies}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/RED-LHC-hardware.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/MODECollaborationWorkshop.pdf}

\subsection{MTD report, CMS week plenary upgrade}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/PlenaryUpgrade.pdf}

\subsection{SUSY (edge/chargino top/chargino) at CMS, 5th Red LHC Workshop}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/RED-LHC-Edge.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/RED-LHC-computing.pdf}

\subsection{Software developments and updates on performance projections, MTD Annual Review}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/AnnualReview.pdf}

\subsection{MTD Reconstruction plans, MTD Days 2020}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/TimingDays2020.pdf}

\subsection{MTD L1 Trigger: physics opportunities, MTD L1 Trigger Workshop}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/MTDLevel1Workshop.pdf}

\subsection{TBT plans for legacy and plans for combinations, CMS SUYS Workshop}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/SUSYWorkshopViena.pdf}

\subsection{Overview of the TBT group, CMS SUYS Workshop}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/SUSYWorkshopGante.pdf}

\subsection{Status of CMS SUSY analysis for the CERN Jamboree, CMS Week}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/SUSYPlenaryCMSWeek2015.pdf}

\subsection{A trigger strategy for the SUSY group, CMS Trigger Workshop at Padova}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CMSTriggerWorkshopPadova.pdf}

\subsection{A proposal of standard model background requests for the SUSY group, CMS Susy Workshop Autumm 2014}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CMSSUSYChicago.pdf}

\subsection{A trigger strategy for the SUSY group, CMS Trigger Workshop at Strasbourg}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CMSTriggerWorkshopStrasbourg.pdf}

\subsection{A trigger strategy for the SUSY group, CMS Trigger Workshop at Brussels}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CMSTriggerWorkshopBrussels.pdf}

\subsection{SUSY search with two leptons, jets and MET: the Edge, CMS Physics Week}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/SUSYCMSWeekLisbon.pdf}

\subsection{Detailed comparisons between CMSSW 52x and 53x (Plenary talk, CMS Physics Week)}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CMSWeekLisbon.pdf}

\subsection{Status of the alignment of the muon system, CMS Muon Barrel Workshop}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CMSMuonBarrelWorkshop.pdf}

\subsection{Drift Tube Alignment with tracks, International CMS workshop on cosmic data analysis}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/CRAFTAnalysisworkshop.pdf}

\subsection{CMS: Muon hardware system and MTCC experience, Second LHC Alignment Workshop}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Workshops/2ndLHCDetectorAlignmentWorkshop.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/Divulgacion/Docencia_OtrosMeritos_Divulgacion_Cafe_Cientifico_2021.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/ComitesCientificosTecnicosAsesores/Transferencia_OtrosMeritos_Technical_Meeting_On_Non-Destructive_Testing.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/ForosYComitesNacionalesInternacionales/yearofphysics.pdf}
...
\includepdf[pages=-]{ActividadCientificaYTecnologica/Premios/titular.pdf}
\subsection{Acreditación I3}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Premios/I3.pdf}
\subsection{Acreditación Contratado doctor}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Premios/contratadodoctor.pdf}
\subsection{Acreditación Ayudante doctor}
\includepdf[pages=-]{ActividadCientificaYTecnologica/Premios/ayudantedoctor.pdf}
